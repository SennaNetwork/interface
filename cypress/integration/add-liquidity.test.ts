describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('contain.text', 'SEN')
  })
  ...
  it('does not crash if SEN is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena .token-symbol-container').should('contain.text', 'SEN')
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('not.contain.text', 'SEN')
  })
